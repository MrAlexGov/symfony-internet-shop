...
class Compare
{
    ...
    #[ORM\OneToOne(targetEntity: User::class, inversedBy: 'compare')]
    ...
    #[ORM\OneToMany(targetEntity: CompareItem::class, mappedBy: 'compare', cascade: ['persist', 'remove'])]
    private $items;
    ...
    public function removeItem(CompareItem $item): static
    {
        if ($this->items->removeElement($item)) {
            if ($item->getCompare() === $this) {
                $item->setCompare(null);
            }
        }
    ...
    {
        return $this->getTotalItems() < 4; // Максимум 4 товара для сравнения
    }
